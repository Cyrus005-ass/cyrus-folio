...
<header class='navbar'>
    <div class='container nav-inner'>
        <a class='brand brand-text' href='<?= url('/') ?>' aria-label='<?= e($brandName) ?>' title='<?= e($brandName) ?>'>
            <?php if ($useLogoVideo): ?>
        ...
        <nav id='site-nav' class='nav-links'>
            ...
            <a class='<?= active_class('/about') ?>' href='<?= url('/about') ?>'>À propos</a>
            <a class='<?= active_class('/projects') ?>' href='<?= url('/projects') ?>'>Projets</a>
            <a class='<?= active_class('/skills') ?>' href='<?= url('/skills') ?>'>Compétences</a>
            ...
            <a class='btn nav-cta' href='<?= url('/contact') ?>'>Démarrer</a>
        </nav>
    </div>
</header>
