<div class='chatbot'>
    <div class='chat-panel' id='portfolio-chatbot' aria-hidden='true' data-chat-panel data-chat-endpoint='<?= e(url('/api/v1/chatbot/message')) ?>'>
        <div class='chat-head'>
            <div class='chat-head-copy'>
                <strong>Assistant de Cyrus-y</strong>
                <span>Profil, projets, competences et certifications.</span>
            </div>
        ...
        <div class='chat-body' role='log' aria-live='polite' aria-label='Conversation avec l assistant' data-chat-body>
            ...
            <div class='bubble assistant is-welcome'>Bonjour. Pose-moi une question sur le profil, les projets, les competences ou les certifications.</div>
        </div>
        <form class='chat-form' data-chat-form>
            <label class='sr-only' for='portfolio-chatbot-message'>Votre question</label>
            <textarea class='input chat-input' id='portfolio-chatbot-message' name='message' placeholder='Ecris ici ta question...' rows='1' maxlength='400' data-chat-input></textarea>
